...
SECRET_KEY = 'django-insecure-ayr7uk#+&_(igy%%xh7$rgr!yb@!24&^=tly(fn5awb(ip!f(j'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'python', #=> database name
        'USER': 'abdo',
        'PASSWORD': '1',     # to ensure u made connection right way ---> make migrations !!!
        'HOST': 'localhost'
    }
}
